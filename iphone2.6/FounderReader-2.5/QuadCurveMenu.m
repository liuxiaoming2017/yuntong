...
#define NEARRADIUS 50.0f
#define ENDRADIUS 50.0f
#define FARRADIUS 50.0f
#define STARTPOINT CGPointMake([UIScreen mainScreen].bounds.size.width-30, [UIScreen mainScreen].bounds.size.height-20)
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray
{
    ...
    if (self) {
        ...
        _addButton = [[QuadCurveMenuItem alloc] initWithImage:[UIImage imageNamed:@"bg-menuitem.png"]
                                       highlightedImage:[UIImage imageNamed:@"bg-menuitem.png"]
                                           ContentImage:[UIImage imageNamed:@"bg-menuitem.png"]
                                highlightedContentImage:[UIImage imageNamed:@"bg-menuitem.png"]];
