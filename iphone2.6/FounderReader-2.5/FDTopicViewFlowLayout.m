...
@interface FDTopicViewFlowLayout () <UIGestureRecognizerDelegate>
...
@implementation FDTopicViewFlowLayout
{
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            FDTopicImageCell *sourceCell = (FDTopicImageCell *)sourceCollectionViewCell;
