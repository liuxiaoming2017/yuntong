...
{
    UIView *myColumnsView = [[[UIView alloc]init] autorelease];
    ...
    operationLabel.text = @"单机增删频道,长按拖拽排序";
...
-(UIView*)moreColumnsView
{
    ...
    moreColumnsView = [[[UIView alloc]init] autorelease];
...
-(void)dealloc
{
//    [_topColumArray release];
//    [_bottomColumArray release];
    [super dealloc];
}
