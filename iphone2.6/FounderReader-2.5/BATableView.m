...
@property (nonatomic, retain) UILabel * flotageLabel;
@property (nonatomic, retain) BATableViewIndex * tableViewIndex;
@end

@implementation BATableView
@synthesize tableView,tableViewIndex,flotageLabel;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        tableViewIndex = [[BATableViewIndex alloc] initWithFrame:(CGRect){kSWidth-20,0,20,frame.size.height}];
