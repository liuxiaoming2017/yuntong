...
- (CAShapeLayer *)scanRectLayer
{
    if (!_scanRectLayer) {
        ...
        _scanRectLayer.strokeColor = [ColorStyleConfig sharedColorStyleConfig].nav_bar_color.CGColor;
    }
...
- (void)setupScanRect
{
    ...
    CGFloat minY = (SCREENHEIGHT - size) * 0.5 / SCREENHEIGHT - .1;
    CGFloat maxY = (SCREENHEIGHT + size) * 0.5 / SCREENHEIGHT - .1;
