...
//    int minLength = CGRectGetHeight(cropRect)>CGRectGetHeight(cropRect) ? CGRectGetHeight(cropRect):CGRectGetHeight(cropRect);
//    cropRect.size = CGSizeMake(minLength,minLength);
