...
- (void)initialization
{
    ...
    _titleLabelBackgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1.0];
...
//        [self.imagesGroup setObject:[UIImage imageNamed:@"forum-top"] atIndexedSubscript:i];
...
//        [self.imagesGroup setObject:[UIImage imageNamed:@"forum-top"] atIndexedSubscript:index];
        // 网络加载图片并缓存图片
