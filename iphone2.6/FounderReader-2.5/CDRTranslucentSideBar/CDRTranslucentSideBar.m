...
- (void)show {
    [MobClick event:@"function_nav" attributes:@{@"home_left_nav_buttion_click":NSLocalizedString(@"主页左侧滑呼出按钮", nil)}];
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)recognizer {
	...
	if (recognizer.state == UIGestureRecognizerStateChanged) {
        ...
        self.view.backgroundColor = [UIColor colorWithRed:-frame.origin.x/255.0 green:-frame.origin.x/255.0 blue:-frame.origin.x/255.0 alpha:.3];
	}
